...
// amplify/functions/admin-update-contact-attrs/handler.ts
var handler_exports = {};
...
var handler = async (event) => {
  ...
  const { contactId, initialContactId, attributes, actor } = body;
  ...
  try {
    await connect.send(
      new import_client_connect.UpdateContactAttributesCommand({
