 ...
 * `connectview-hsm-sends` audit table). El overlay, focus-trap y Esc los
 * aporta el primitivo `Modal`.
 */
    ...
    <Modal
      ...
      title={
        <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
          <Icon.WhatsApp size={15} style={{ color: "var(--accent-green)" }} />
          Enviar WhatsApp
        </span>
      }
      description="Template aprobado · via Amazon Connect"
      className="max-w-md"
      footer={
        <>
