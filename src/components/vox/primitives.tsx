...
export function Spark({ data, color = "var(--accent-cyan)", w = 80, h = 28, fill }: SparkProps) {
  const path = useMemo(() => {
...
export const Chat = makeIcon(<path d="M21 12a8 8 0 0 1-11.5 7.2L4 21l1.8-5.5A8 8 0 1 1 21 12z" />);
...
export const Cloud = makeIcon(<path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" />);
...
export const Lightning = makeIcon(<path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z" />);
