        ...
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          {STEPS[step].key === "instance" && (
            <div>
              ...
              <Details>
                El ARN lo encontrás en tu consola de Connect → Información de la cuenta. Con él, Vox
          ...
          {STEPS[step].key === "role" && (
            <div>
              ...
              <Details>
                ...
                Tu External ID es <code>{draft.externalId}</code> — el código anti-suplantación que solo vos y Vox conocen.
              </Details>
            </div>
          )}
          ...
          {STEPS[step].key === "dataplane" && (
            <div>
              ...
              <p style={{ fontSize: 14, color: "var(--text-2)", marginTop: 8, lineHeight: 1.6 }}>
                Vox <b>no guarda datos de empresas en su cuenta</b>. Tus leads, campañas, contactos y
              ...
              {draft.dataPlaneEnabled ? (
                <div style={{ marginTop: 14, padding: 12, borderRadius: 8, background: "var(--accent-green-soft)", color: "var(--accent-green)", fontSize: 12.5, fontWeight: 600 }}>
                  ✓ Tus tablas existen. Vox va a leer y escribir en TU cuenta.
                </div>
              ) : (
                <div style={{ marginTop: 14, padding: 12, borderRadius: 8, background: "var(--accent-amber-soft)", color: "var(--text-2)", fontSize: 12.5, lineHeight: 1.5 }}>
                  Para continuar, creá las tablas y verificalas. Sin esto, Vox no tiene dónde guardar tus datos.
                </div>
              )}
              <Details>
