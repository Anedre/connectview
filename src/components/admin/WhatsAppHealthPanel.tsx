      ...
      <Card>
        <CardBody>
          ...
          <div className="muted" style={{ fontSize: 12, marginTop: 4 }}>
            {health?.error
              ? `No se pudo leer la salud: ${health.error}`
              : "No hay un número de WhatsApp configurado todavía."}
          </div>
        </CardBody>
      </Card>
    );
        ...
        {health.alert && (
          ...
          >
            <AlertTriangle
              ...
              style={{
                color:
                  health.alert.level === "critical" ? "var(--accent-red)" : "var(--accent-amber)",
                flex: "0 0 auto",
                marginTop: 1,
              }}
            />
          ...
          {health.wabas.map((w) => (
            ...
            >
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      <div className="muted" style={{ fontSize: 11 }}>
                        ...
                        {n.registrationStatus
                          ? ` · ${n.registrationStatus === "COMPLETE" ? "registrado" : n.registrationStatus}`
                          : ""}
                      </div>
                    </div>
              ...
              >
                {w.anchoredToConnect ? (
                  <>
                    📥 <b>Inbound integrado en Connect</b> (los chats entran como contactos del
                    agente), pero el <b>estado de entrega por-mensaje no está disponible</b> para
                    este número — los eventos van a Connect. Para ver entregado/leído por mensaje,
                    conecta un número de WhatsApp de Meta <b>no anclado a Connect</b>.
                  </>
                ) : (
                  <>
                    ✅ <b>Deliverability completa</b>: ARIA recibe los recibos de entrega
                    (entregado/leído/fallido por mensaje) y cuarentena los números inválidos
                    automáticamente.
                  </>
                )}
              </div>
