...
export const NAV_ACTIONS: { route: string; label: string; hint: string }[] = [
  ...
  { route: "/bot", label: "Bots", hint: "crear o editar un bot (flow builder)" },
  { route: "/journeys", label: "Journeys", hint: "crear un journey de nurturing/seguimiento" },
  { route: "/automations", label: "Automatizaciones", hint: "reglas disparador → acción" },
  { route: "/agente", label: "Agente IA", hint: "configurar el agente IA híbrido" },
