...
export const BOT_TEMPLATES: BotTemplate[] = [
  ...
  },
  {
    ...
    description: "Responde distinto si estás abierto o cerrado y deriva en horario.",
    icon: "hours",
    accent: "#E0A23B",
    category: "trabajo",
    channels: ["whatsapp"],
    ...
    build: () => ({
      ...
      nodes: [
        ...
        },
        {
          ...
          position: { x: -40, y: 360 },
          data: {
            text: "¡Hola! 👋 Estamos en línea. Te paso con un asesor ahora mismo.",
            buttons: [],
          },
        },
        {
          ...
          data: {
            ...
            priority: "normal",
            assignTo: "",
            note: "Contacto en horario de atención.",
          },
        },
        {
          id: "mclosed",
          ...
          data: {
            text: "¡Gracias por escribirnos! 🌙 Ahora estamos cerrados (Lun a Vie, 9–18h). Te respondemos apenas abramos.",
            buttons: [],
          },
        },
        { id: "s1", kind: "stop", position: { x: -40, y: 720 }, data: {} },
        { id: "s2", kind: "stop", position: { x: 520, y: 540 }, data: {} },
      ],
      edges: [
        { id: "e0", source: "start", sourceHandle: "out", target: "bh1" },
        { id: "e1", source: "bh1", sourceHandle: "open", target: "mopen" },
        { id: "e2", source: "bh1", sourceHandle: "closed", target: "mclosed" },
        { id: "e3", source: "mopen", sourceHandle: "out", target: "hand1" },
        { id: "e4", source: "hand1", sourceHandle: "out", target: "s1" },
        { id: "e5", source: "mclosed", sourceHandle: "out", target: "s2" },
      ],
    }),
  },
  {
    id: "abtest",
    name: "Prueba A/B de mensaje",
    description: "Divide el tráfico y compara dos aperturas para ver cuál convierte.",
    icon: "split",
    accent: "#A855F7",
    category: "cultivar",
    channels: ["whatsapp"],
    preview: {
      bubble: "🎁 Oferta exclusiva por hoy — ¿la vemos?",
      reply: "¡Sí!",
      emoji: "🔀",
    },
    build: () => ({
      ...
      nodes: [
        ...
        },
        {
          ...
          data: {
            ...
            priority: "normal",
            assignTo: "",
            note: "Interesado desde prueba A/B.",
          },
        },
        { id: "s1", kind: "stop", position: { x: 240, y: 780 }, data: {} },
        { id: "s2", kind: "stop", position: { x: 560, y: 600 }, data: {} },
      ],
      edges: [
        { id: "e0", source: "start", sourceHandle: "out", target: "split1" },
        { id: "e1", source: "split1", sourceHandle: "a", target: "ma" },
        { id: "e2", source: "split1", sourceHandle: "b", target: "mb" },
        { id: "e3", source: "ma", sourceHandle: "b:si", target: "hand1" },
        { id: "e4", source: "ma", sourceHandle: "b:no", target: "s2" },
        { id: "e5", source: "mb", sourceHandle: "b:si", target: "hand1" },
        { id: "e6", source: "mb", sourceHandle: "b:no", target: "s2" },
        { id: "e7", source: "hand1", sourceHandle: "out", target: "s1" },
      ],
    }),
  },
  {
    ...
    description: "Confirma el concepto y envía un enlace de pago listo para abonar.",
    icon: "card",
    accent: "#16A34A",
    category: "comercial",
    channels: ["whatsapp"],
    ...
    build: () => ({
      ...
      nodes: [
        blankStart(),
        {
          ...
          position: { x: 240, y: 120 },
          data: {
            text: "¡Perfecto! 💳 Te genero el link para completar el pago de forma segura.",
            buttons: [],
          },
        },
        {
          ...
          data: {
            ...
            amount: "150.00",
            currency: "PEN",
            url: "https://pago.tu-empresa.com/checkout",
          },
        },
        {
          id: "m2",
          ...
          position: { x: 240, y: 480 },
          data: {
            text: "Cuando completes el pago, tu lugar queda confirmado. ✅ ¡Cualquier duda, escribime!",
            buttons: [],
          },
        },
        { id: "s1", kind: "stop", position: { x: 240, y: 660 }, data: {} },
      ],
      edges: [
        { id: "e0", source: "start", sourceHandle: "out", target: "m1" },
        { id: "e1", source: "m1", sourceHandle: "out", target: "pay1" },
        { id: "e2", source: "pay1", sourceHandle: "out", target: "m2" },
        { id: "e3", source: "m2", sourceHandle: "out", target: "s1" },
      ],
    }),
  },
  {
    id: "recomienda",
    name: "Recomendador",
    description: "Pregunta el interés y recomienda por condición (o deriva a un asesor).",
    icon: "branch",
    accent: "#E0A23B",
    category: "leads",
    channels: ["whatsapp", "instagram"],
    ...
    build: () => ({
      ...
      nodes: [
        blankStart(),
        {
          ...
          position: { x: 240, y: 120 },
          data: {
            prompt: "¡Hola! Para recomendarte mejor, ¿qué te interesa? (pregrado / posgrado)",
            saveAs: "interes",
            validate: "ninguna",
          },
        },
        {
          ...
          kind: "condition",
          position: { x: 240, y: 320 },
          data: { variable: "interes", op: "contains", value: "pregrado" },
        },
        {
          id: "mpre",
          kind: "message",
          position: { x: -40, y: 520 },
          data: {
            text: "¡Genial! 🎓 Para pregrado te recomiendo empezar por nuestras carreras destacadas. Te envío el detalle.",
            buttons: [],
          },
        },
        {
          ...
          data: {
            ...
            priority: "normal",
            assignTo: "",
            note: "Interés: {{interes}} — recomendar posgrado.",
          },
        },
        { id: "s1", kind: "stop", position: { x: -40, y: 700 }, data: {} },
        { id: "s2", kind: "stop", position: { x: 520, y: 700 }, data: {} },
      ],
      edges: [
        { id: "e0", source: "start", sourceHandle: "out", target: "q1" },
        { id: "e1", source: "q1", sourceHandle: "out", target: "c1" },
        { id: "e2", source: "c1", sourceHandle: "true", target: "mpre" },
        { id: "e3", source: "c1", sourceHandle: "false", target: "hpos" },
        { id: "e4", source: "mpre", sourceHandle: "out", target: "s1" },
        { id: "e5", source: "hpos", sourceHandle: "out", target: "s2" },
      ],
    }),
  },
];
